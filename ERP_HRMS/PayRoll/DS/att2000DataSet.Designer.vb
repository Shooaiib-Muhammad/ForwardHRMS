...
Partial Public Class att2000DataSet
    ...
    Partial Public Class CHECKINOUTDataTable
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>  _
        Public Overloads Function AddCHECKINOUTRow(ByVal DeviceNo As String, ByVal AttDate As Date, ByVal USERID As String, ByVal AttTime As Date) As CHECKINOUTRow
            Dim rowCHECKINOUTRow As CHECKINOUTRow = CType(Me.NewRow,CHECKINOUTRow)
            Dim columnValuesArray() As Object = New Object() {DeviceNo, AttDate, USERID, AttTime}
...
Namespace att2000DataSetTableAdapters
    ...
    Partial Public Class CHECKINOUTTableAdapter
        ...
        Private Sub InitConnection()
            ...
            Me._connection.ConnectionString = Global.ERP_HRMS.My.MySettings.Default.att2000ConnectionString
        End Sub
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0).CommandText = "SELECT        USERINFO.Badgenumber AS USERID, datevalue(CHECKINOUT.CHECKTIME) AS "& _ 
                "AttDate, CHECKINOUT.CHECKTIME AS AttTime, CHECKINOUT.SENSORID AS DeviceNo"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"FROM "& _ 
                "           (CHECKINOUT INNER JOIN"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"                         USERINFO ON CHECKINO"& _ 
                "UT.USERID = USERINFO.USERID)"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"WHERE        (CHECKINOUT.CHECKTIME BETWEEN ? AND ?"& _ 
                ")"
            Me._commandCollection(0).CommandType = Global.System.Data.CommandType.Text
            Me._commandCollection(0).Parameters.Add(New Global.System.Data.OleDb.OleDbParameter("CHECKTIME", Global.System.Data.OleDb.OleDbType.[Date], 0, Global.System.Data.ParameterDirection.Input, CType(0,Byte), CType(0,Byte), "AttTime", Global.System.Data.DataRowVersion.Current, false, Nothing))
            Me._commandCollection(0).Parameters.Add(New Global.System.Data.OleDb.OleDbParameter("CHECKTIME1", Global.System.Data.OleDb.OleDbType.[Date], 0, Global.System.Data.ParameterDirection.Input, CType(0,Byte), CType(0,Byte), "AttTime", Global.System.Data.DataRowVersion.Current, false, Nothing))
            Me._commandCollection(1) = New Global.System.Data.OleDb.OleDbCommand()
            Me._commandCollection(1).Connection = Me.Connection
            Me._commandCollection(1).CommandText = "SELECT        USERINFO.Badgenumber AS USERID, datevalue(CHECKINOUT.CHECKTIME) AS "& _ 
                "AttDate, CHECKINOUT.CHECKTIME AS AttTime, "&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"                         CHECKINOUT."& _ 
                "SENSORID AS DeviceNo"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"FROM            (CHECKINOUT INNER JOIN"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"                  "& _ 
                "       USERINFO ON CHECKINOUT.USERID = USERINFO.USERID)"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"WHERE        (CHECKINOU"& _ 
                "T.SENSORID = ?) AND (CHECKINOUT.CHECKTIME BETWEEN ? AND ?) "
            Me._commandCollection(1).CommandType = Global.System.Data.CommandType.Text
            Me._commandCollection(1).Parameters.Add(New Global.System.Data.OleDb.OleDbParameter("SENSORID", Global.System.Data.OleDb.OleDbType.WChar, 5, Global.System.Data.ParameterDirection.Input, CType(0,Byte), CType(0,Byte), "DeviceNo", Global.System.Data.DataRowVersion.Current, false, Nothing))
            Me._commandCollection(1).Parameters.Add(New Global.System.Data.OleDb.OleDbParameter("CHECKTIME", Global.System.Data.OleDb.OleDbType.[Date], 0, Global.System.Data.ParameterDirection.Input, CType(0,Byte), CType(0,Byte), "AttTime", Global.System.Data.DataRowVersion.Current, false, Nothing))
            Me._commandCollection(1).Parameters.Add(New Global.System.Data.OleDb.OleDbParameter("CHECKTIME1", Global.System.Data.OleDb.OleDbType.[Date], 0, Global.System.Data.ParameterDirection.Input, CType(0,Byte), CType(0,Byte), "AttTime", Global.System.Data.DataRowVersion.Current, false, Nothing))
        End Sub
        ...
        Public Overloads Overridable Function Fill(ByVal dataTable As att2000DataSet.CHECKINOUTDataTable, ByVal CHECKTIME As Date, ByVal CHECKTIME1 As Date) As Integer
        ...
        Public Overloads Overridable Function GetData(ByVal CHECKTIME As Date, ByVal CHECKTIME1 As Date) As att2000DataSet.CHECKINOUTDataTable
            Me.Adapter.SelectCommand = Me.CommandCollection(0)
            Me.Adapter.SelectCommand.Parameters(0).Value = CType(CHECKTIME,Date)
            Me.Adapter.SelectCommand.Parameters(1).Value = CType(CHECKTIME1,Date)
        ...
        Public Overloads Overridable Function FillBy(ByVal dataTable As att2000DataSet.CHECKINOUTDataTable, ByVal SENSORID As String, ByVal CHECKTIME As Date, ByVal CHECKTIME1 As Date) As Integer
        ...
        Public Overloads Overridable Function GetDataBy(ByVal SENSORID As String, ByVal CHECKTIME As Date, ByVal CHECKTIME1 As Date) As att2000DataSet.CHECKINOUTDataTable
            Me.Adapter.SelectCommand = Me.CommandCollection(1)
            If (SENSORID Is Nothing) Then
                Me.Adapter.SelectCommand.Parameters(0).Value = Global.System.DBNull.Value
            Else
