...
Imports System.IO
Public Class frmCanteenAttAcessToDB
        ...
        For i As Integer = 0 To Me.DataGridView1.RowCount - 1
            ...
            If Me.View_All_EmployeesBindingSource.Count > 0 Then
                Try
                    ...
                    Dim IpNo As Integer = Me.DataGridView1(3, i).Value

                    'countAtt = Me.Tbl_HRM_Emp_Att_MealTableAdapter.Duplication(Me.DSPayRoll.View_All_Employees(0).Item("CardNo"), AttDate1)
                    'If countAtt = 0 Then
                    Me.Tbl_HRM_Emp_Att_MealTableAdapter.Insert(Me.DSPayRoll.View_All_Employees(0).Item("EmpID"), Me.DSPayRoll.View_All_Employees(0).Item("CardNo"), AttDate1, Now.Date, Nothing, 1, Nothing, IpNo, AttendTime)
        ...
        For i As Integer = 0 To Me.CHECKINOUTDataGridView.RowCount - 1
            ...
            If Me.View_All_EmployeesBindingSource.Count > 0 Then
                Try
                    ...
                    Dim IpNo As Integer = CHECKINOUTDataGridView(3, i).Value
    ...
    Private Sub frmAttAcessToDB_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        Me.Tbl_Att_DeviceTableAdapter.FillBy1(Me.DSPayRoll.tbl_Att_Device)
        verify()
        ...
        Try
            If TabControl1.SelectedTab.Text = "ZkTeco" Then
                ...
                ElseIf RadioButton3.Checked Then 'All Record
                    ...
                    Me.Tbl_Att_DeviceSpecial_NewTableAdapter.Canteen_FillBy(Me.DSDevice.tbl_Att_DeviceSpecial_New)
                    If Me.Tbl_Att_DeviceSpecial_NewBindingSource.Count > 0 Then
                        Dim Ret As Integer = Me.Tbl_Att_DeviceSpecial_NewBindingSource.Count
                        For i As Integer = 0 To Ret - 1
                            NewDivNo = Me.DSDevice.tbl_Att_DeviceSpecial_New(i).Item("DeviceNo")
