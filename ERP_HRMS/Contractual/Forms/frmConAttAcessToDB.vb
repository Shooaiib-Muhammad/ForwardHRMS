...
Imports System.IO
Public Class frmConAttAcessToDB
    ...
    Private Sub zkteco()
        ...
        For i As Integer = 0 To Me.DataGridView1.RowCount - 1
            ...
            Try
                Me.View_All_ContTableAdapter.FillBy(Me.DSPayRoll.View_All_Cont, cardNo)
            Catch ex As Exception

            End Try
            If Me.View_All_ContBindingSource.Count > 0 Then
                FP = obj.ReturnFP(AttendTime.Month, AttendTime.Year)
                If AttendTime < DateAdd(DateInterval.Minute, -120, DateTime.Parse(AttendTime.ToShortDateString() & " " & Me.DSPayRoll.View_All_Cont(0).Item("ShiftST").ToShortTimeString())) Then
                    'Out With 1 day Less
                ...
                Dim Shift As Integer = Me.DSPayRoll.View_All_Cont(0).Item("ShiftID")
                Dim BreakST As DateTime = Me.DSPayRoll.View_All_Cont(0).Item("BreakST")
                Dim BreakET As DateTime = Me.DSPayRoll.View_All_Cont(0).Item("BreakET")
                ...
                If WeekdayName(Weekday(AttDate1)) = "Friday" Then
                    ...
                    Else
                        ...
                        BreakST = Me.DSPayRoll.View_All_Cont(0).Item("BreakST")
                        BreakET = Me.DSPayRoll.View_All_Cont(0).Item("BreakET")
                    End If
                Else
                    ShiftST = Me.DSPayRoll.View_All_Cont(0).Item("ShiftST")
                    ShiftET = Me.DSPayRoll.View_All_Cont(0).Item("ShiftET")
                ...
                Try
                    ...
                    countAtt = Me.Tbl_Hrm_Cont_AttTableAdapter.DuplicateAtt(Me.DSPayRoll.View_All_Cont(0).Item("CardNo"), AttDate1, AttendTime)
                    If countAtt = 0 Then
                        Me.Tbl_Hrm_Cont_AttTableAdapter.Insert(Me.DSPayRoll.View_All_Cont(0).Item("CardNo"), Me.DSPayRoll.View_All_Cont(0).Item("EmpID"), AttDate1, AttendTime, Nothing, Nothing, Shift, Nothing, Me.DSPayRoll.View_All_Cont(0).Item("ShiftST"), ShiftET, BreakST, BreakET, FP, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing, DecviceNo)
                    ...
                    If Me.DSPayRoll.View_All_Cont.Rows(0).Item("EndDate") < AttendTime.ToShortDateString Then
        ...
        For i As Integer = 0 To Me.CHECKINOUTDataGridView.RowCount - 1
            ...
            If Me.View_All_ContBindingSource.Count > 0 Then
                ...
                Try
                    ...
                    countAtt = Me.Tbl_Hrm_Cont_AttTableAdapter.DuplicateAtt(Me.DSPayRoll.View_All_Cont(0).Item("CardNo"), AttDate1, AttendTime)
                    If countAtt = 0 Then
                        Me.Tbl_Hrm_Cont_AttTableAdapter.Insert(Me.DSPayRoll.View_All_Cont(0).Item("CardNo"), Me.DSPayRoll.View_All_Cont(0).Item("EmpID"), AttDate1, AttendTime, Nothing, True, Shift, Nothing, Me.DSPayRoll.View_All_Cont(0).Item("ShiftST"), ShiftET, BreakST, BreakET, FP, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing, DecviceNo)
    ...
    Private Sub frmAttAcessToDB_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Me.Tbl_Att_DeviceTableAdapter.FillBy2(Me.DSPayRoll.tbl_Att_Device)
        verify()
    ...
    '    Try
    '        Me.View_All_ContTableAdapter.Fill(Me.DSPayRoll.View_All_Cont, CType(EmpIDToolStripTextBox.Text, Integer))
