...
<Global.System.Serializable(),  _
 ...
 Global.System.Xml.Serialization.XmlRootAttribute("DSTeamWork"),  _
 Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.DataSet")>  _
Partial Public Class DSTeamWork
    ...
    Public Overrides Function Clone() As Global.System.Data.DataSet
        Dim cln As DSTeamWork = CType(MyBase.Clone,DSTeamWork)
        cln.InitVars
    ...
    Private Sub InitClass()
        Me.DataSetName = "DSTeamWork"
        Me.Prefix = ""
        Me.Namespace = "http://tempuri.org/DSTeamWork.xsd"
    ...
    Public Shared Function GetTypedDataSetSchema(ByVal xs As Global.System.Xml.Schema.XmlSchemaSet) As Global.System.Xml.Schema.XmlSchemaComplexType
        Dim ds As DSTeamWork = New DSTeamWork()
    ...
    Partial Public Class View_TeamWork_kaizen_activity_recordDataTable
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>  _
        Public Overloads Function AddView_TeamWork_kaizen_activity_recordRow(ByVal KARCode As String, ByVal Title As String, ByVal KaizenDate As Date, ByVal CardNo As Integer) As View_TeamWork_kaizen_activity_recordRow
            ...
            Dim columnValuesArray() As Object = New Object() {KARCode, Title, KaizenDate, Nothing, CardNo}
    ...
    Partial Public Class View_TeamWork_kaizen_activity_recordRow
        ...
        Public Property CardNo() As Integer
            Get
                Return CType(Me(Me.tableView_TeamWork_kaizen_activity_record.CardNoColumn),Integer)
            End Get
            Set
                Me(Me.tableView_TeamWork_kaizen_activity_record.CardNoColumn) = value
            End Set
        End Property
    End Class
...
Namespace DSTeamWorkTableAdapters
    ...
    Partial Public Class View_TeamWork_kaizen_activity_recordTableAdapter
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0).CommandText = "SELECT        tbl_Hrm_Emp_Info.CardNo, tbl_Hrm_kaizen_activity_record.KARCode, tb"& _ 
                "l_Hrm_kaizen_activity_record.Title, tbl_Hrm_kaizen_activity_record.KaizenDate, "&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"                         tbl_Hrm_Emp_Info.EmpID"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"FROM            tbl_Hrm_kaizen"& _ 
                "_activity_record, tbl_Hrm_Emp_Info"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"WHERE        tbl_Hrm_kaizen_activity_record."& _ 
                "TWCard = tbl_Hrm_Emp_Info.CardNo AND (tbl_Hrm_kaizen_activity_record.TWStatus = "& _ 
                "1) AND "&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"                         (tbl_Hrm_kaizen_activity_record.KaizenDate BET"& _ 
                "WEEN ? AND ?) AND (tbl_Hrm_Emp_Info.CardNo = ?)"
        ...
        Public Overloads Overridable Function Fill(ByVal dataTable As DSTeamWork.View_TeamWork_kaizen_activity_recordDataTable, ByVal KaizenDate As Date, ByVal KaizenDate1 As Date, ByVal CardNo As Integer) As Integer
            Me.Adapter.SelectCommand = Me.CommandCollection(0)
            Me.Adapter.SelectCommand.Parameters(0).Value = CType(KaizenDate,Date)
            Me.Adapter.SelectCommand.Parameters(1).Value = CType(KaizenDate1,Date)
        ...
        Public Overloads Overridable Function GetData(ByVal KaizenDate As Date, ByVal KaizenDate1 As Date, ByVal CardNo As Integer) As DSTeamWork.View_TeamWork_kaizen_activity_recordDataTable
            Me.Adapter.SelectCommand = Me.CommandCollection(0)
            Me.Adapter.SelectCommand.Parameters(0).Value = CType(KaizenDate,Date)
            Me.Adapter.SelectCommand.Parameters(1).Value = CType(KaizenDate1,Date)
            Me.Adapter.SelectCommand.Parameters(2).Value = CType(CardNo,Integer)
            Dim dataTable As DSTeamWork.View_TeamWork_kaizen_activity_recordDataTable = New DSTeamWork.View_TeamWork_kaizen_activity_recordDataTable()
    ...
    Partial Public Class TableAdapterManager
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>  _
        Private Function UpdateUpdatedRows(ByVal dataSet As DSTeamWork, ByVal allChangedRows As Global.System.Collections.Generic.List(Of Global.System.Data.DataRow), ByVal allAddedRows As Global.System.Collections.Generic.List(Of Global.System.Data.DataRow)) As Integer
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>  _
        Private Function UpdateInsertedRows(ByVal dataSet As DSTeamWork, ByVal allAddedRows As Global.System.Collections.Generic.List(Of Global.System.Data.DataRow)) As Integer
            Dim result As Integer = 0
            Return result
        End Function
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>  _
        Private Function UpdateDeletedRows(ByVal dataSet As DSTeamWork, ByVal allChangedRows As Global.System.Collections.Generic.List(Of Global.System.Data.DataRow)) As Integer
            Dim result As Integer = 0
            Return result
        End Function
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>  _
        Public Overridable Function UpdateAll(ByVal dataSet As DSTeamWork) As Integer
