Public Class frmAttCorrection
    Private Sub frmAttCorrection_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        Try
            Me.View_AttTableAdapter.Fill(Me.DSAttCorection.View_Att, Me.DateTimePicker1.Text, Me.DateTimePicker2.Text)
    ...
    Private Sub View_AttDataGridView_CellContentClick(sender As Object, e As DataGridViewCellEventArgs) Handles View_AttDataGridView.CellContentClick
        If e.ColumnIndex = 6 Then
            ...
            If dgResult = 6 Then
                Me.View_AttTableAdapter.DeleteQuery(Me.View_AttDataGridView(0, e.RowIndex).Value)
                Try
                    Me.View_AttTableAdapter.Fill(Me.DSAttCorection.View_Att, Me.DateTimePicker1.Text, Me.DateTimePicker2.Text)
                Catch ex As Exception
    ...
    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        ...
        If dgResult = 6 Then
            For i As Int16 = 0 To Me.View_AttDataGridView.RowCount - 1
                Me.View_AttTableAdapter.DeleteQuery(Me.View_AttDataGridView(0, i).Value)
            Next
            Try
                Me.View_AttTableAdapter.Fill(Me.DSAttCorection.View_Att, Me.DateTimePicker1.Text, Me.DateTimePicker2.Text)
            Catch ex As Exception
