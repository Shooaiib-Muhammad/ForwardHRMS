...
Public Class SalaryReportViewer

    Friend Function ViewSalaryReport(ByVal sReportName As String, Optional ByVal sSelectionFormula As String = "", Optional ByVal param As String = "") As Boolean
    ...
    End Function
    Private Sub SalaryReportViewer_Load(sender As Object, e As EventArgs) Handles MyBase.Load
