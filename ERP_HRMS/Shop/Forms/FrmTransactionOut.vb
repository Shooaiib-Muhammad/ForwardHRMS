Public Class FrmTransactionOut
    ...
    Private Sub FrmTransout_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        'TODO: This line of code loads data into the 'DSShop.tbl_Shop_Inv_ID' table. You can move, or remove it, as needed.
        'Me.Tbl_Shop_Inv_IDTableAdapter.Fill(Me.DSShop.tbl_Shop_Inv_ID)
        Try

            MyIP = System.Net.Dns.Resolve(Environment.MachineName).AddressList(0).ToString()
            Label24.Text = MyIP
            'TODO: This line of code loads data into the 'DSShop.tbl_Acc_ShortTermAdvances' table. You can move, or remove it, as needed.
            'Me.Tbl_Acc_ShortTermAdvancesTableAdapter.Fill(Me.DSShop.tbl_Acc_ShortTermAdvances)
            ''TODO: This line of code loads data into the 'DSShop.tbl_Shop_Tran_Invoice' table. You can move, or remove it, as needed.
            'Me.Tbl_Shop_Tran_InvoiceTableAdapter.Fill(Me.DSShop.tbl_Shop_Tran_Invoice)
            ''TODO: This line of code loads data into the 'DSShop.tbl_Acc_Salary' table. You can move, or remove it, as needed.
            'Me.Tbl_Acc_SalaryTableAdapter.Fill(Me.DSShop.tbl_Acc_Salary)
            'TODO: This line of code loads data into the 'DSShop.tbl_Shop_Item_NEW' table. You can move, or remove it, as needed.
            '  Me.Tbl_Shop_Item_NEWTableAdapter.Fill(Me.DSShop.tbl_Shop_Item_NEW)
            'Me.View_CardTableAdapter.Fill(Me.DSShop.View_Card)
            'TODO: This line of code loads data into the 'DSShop.tbl_Shop_Item' table. You can move, or remove it, as needed.
            Me.Tbl_Shop_ItemTableAdapter.FillBy1(Me.DSShop.tbl_Shop_Item)
            'TODO: This line of code loads data into the 'DSShop.View_Rpt_Acc_AllEmployees' table. You can move, or remove it, as needed.

            If Me.Tbl_HRM_TranDateTableAdapter.Fill(Me.DSShop.tbl_HRM_TranDate, Now.Date) > 0 Then
                Me.Tbl_HRM_TranDateTableAdapter.Fill(Me.DSShop.tbl_HRM_TranDate, Now.Date.AddDays(0))
            Else
            ...
            Try
                'Me.View_Tran_OutTableAdapter.Fill(Me.DSShop.View_Tran_Out, Me.Label2.Text)
                ...
                If dgResult = 6 Then
                    Try
                        ...
                        Try
                            ...
                            Me.View_Tran_OutTableAdapter.FillBy(Me.DSShop.View_Tran_Out, Me.Label2.Text, Me.CardNoLabel1.Text, MyIP)
                        Catch ex As Exception
    ...
    Private Sub ToolStripButton1_Click(sender As Object, e As EventArgs)
        Try
            ...
            Me.Tbl_Shop_Tran_OutTableAdapter.Update(Me.DSShop.tbl_Shop_Tran_Out)
            Try
                Me.Tbl_Shop_Tran_OutTableAdapter.FillBy(Me.DSShop.tbl_Shop_Tran_Out, Val(Label2.Text))
            Catch ex As Exception
    ...
    Private Sub Tbl_HRM_TranDateBindingSource_PositionChanged(sender As Object, e As EventArgs) Handles Tbl_HRM_TranDateBindingSource.PositionChanged
        Try
            Me.View_Tran_OutTableAdapter.FillBy(Me.DSShop.View_Tran_Out, Me.Label2.Text, TextBox1.Text, MyIP)
        Catch ex As Exception
    ...
    Private Sub TextBox1_TextChanged(sender As Object, e As EventArgs) Handles TextBox1.TextChanged
        If TextBox1.Text.Length = 1 Then
            Try
                Me.View_Tran_OutTableAdapter.FillBy(Me.DSShop.View_Tran_Out, Me.Label2.Text, Me.TextBox1.Text, MyIP)
            ...
            '        If Me.View_Rpt_Acc_AllEmployeesTableAdapter.Fill(Me.DSShop.View_Rpt_Acc_AllEmployees, CardNo) > 0 Then
    ...
    Private Sub TextBox1_KeyPress(sender As Object, e As KeyPressEventArgs) Handles TextBox1.KeyPress
        ...
        'Try
        '    Me.View_Rpt_Acc_AllEmployeesTableAdapter.Fill(Me.DSShop.View_Rpt_Acc_AllEmployees, Val(TextBox1.Text))
        'Catch ex As Exception
                ...
                If Me.RadioButton4.Checked Then
                    ...
                    Try
                        ...
                        If Limt >= Val(TextQty1.Text) * Val(price.Text) Then
                            ...
                            Try
                                'Me.View_Rpt_Acc_AllEmployeesTableAdapter.Fill(Me.DSShop.View_Rpt_Acc_AllEmployees, 0)
                            Catch ex As Exception
                            End Try
                            Me.Tbl_Shop_ItemTableAdapter.FillBy1(Me.DSShop.tbl_Shop_Item)
                            Me.TextBox2.Text = 0
    ...
    Private Sub LoardTerms()
        ...
        If RadioButton3.Checked Then
            PaymentMode = "Cash"
            InvoiceNo = "FS-" + "CASH" + "-" + Label2.Text.ToString + Me.Tbl_Shop_Inv_IDTableAdapter.MaxID.ToString
        ElseIf RadioButton4.Checked Then
            PaymentMode = "Credit"
            InvoiceNo = "FS-" + Me.CardNoLabel1.Text.ToString + "-" + Label2.Text.ToString + Me.Tbl_Shop_Inv_IDTableAdapter.MaxID.ToString
        End If
    ...
    Private Sub TextBox1_LostFocus(sender As Object, e As EventArgs) Handles TextBox1.LostFocus
        ...
        '    Try
        '        Me.View_Tran_OutTableAdapter.FillBy(Me.DSShop.View_Tran_Out, Me.Label2.Text, 0)
        '    Catch ex As Exception
        '    End Try
        'Else
        'Try
        '    If Me.View_Invoice_NoTableAdapter.Fill(Me.DSShop.View_Invoice_No, Me.TextBox1.Text, Me.Label2.Text) > 0 And RadioButton2.Checked = False Then
    ...
    Private Sub TextBox2_TextChanged(sender As Object, e As EventArgs) Handles TextBox2.TextChanged
        ...
        If TextBox2.TextLength >= 1 Then
            Me.Tbl_Shop_ItemTableAdapter.FillBy(Me.DSShop.tbl_Shop_Item, Me.TextBox2.Text)
    ...
    Private Sub printReport(InvoiceID1 As String)
        ...
        Dim Filter As String = ""
        Dim Path As String
        Path = "" & frmLogin.ReportsPath & "\HR\Shop\FairShopInvoice.rpt"
        ...
        obj.PrintReports(Path, Filter, "", 1)
    End Sub
    Private Sub SaveData()
        Try
            Me.Validate()
            Me.View_Tran_OutBindingSource.EndEdit()
            Me.View_Tran_OutTableAdapter.Update(Me.DSShop.View_Tran_Out)
            Try
                Me.View_Tran_OutTableAdapter.FillBy(Me.DSShop.View_Tran_Out, Me.Label2.Text, Me.TextBox1.Text, MyIP)
            Catch ex As Exception
    ...
    Private Sub RadioButton1_CheckedChanged(sender As Object, e As EventArgs) Handles RadioButton1.CheckedChanged, RadioButton2.CheckedChanged
        If RadioButton1.Checked Then
            ...
            Try
                If Me.View_Invoice_NoTableAdapter.Fill(Me.DSShop.View_Invoice_No, Me.TextBox1.Text, Me.Label2.Text) > 0 Then
                    Me.Button1.Enabled = False
                Else
                    Me.Button1.Enabled = True
                End If
