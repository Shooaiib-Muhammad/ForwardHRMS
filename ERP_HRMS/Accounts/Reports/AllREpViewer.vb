...
Public Class AllREpViewer
    Private Sub CrystalReportViewer3_Load(sender As Object, e As EventArgs) Handles CrystalReportViewer3.Load

    End Sub
    'Friend Function ViewAllowanceReport(ByVal sReportName As String, Optional ByVal sSelectionFormula As String = "", Optional ByVal param As String = "") As Boolean
    ...
    'End Function
    Private Sub AllREpViewer_Load(sender As Object, e As EventArgs) Handles MyBase.Load
