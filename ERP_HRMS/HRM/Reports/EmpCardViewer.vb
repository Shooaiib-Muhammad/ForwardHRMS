...
Public Class EmpCardViewer
    Friend Function ViewCardReport(ByVal sReportName As String, Optional ByVal sSelectionFormula As String = "", Optional ByVal param As String = "") As Boolean
        ...
        Try
            ...
            End If
            CrystalReportViewer4.ReportSource = crReportDocument
            CrystalReportViewer4.Show()
            Return True
    ...
    Private Sub EmpCardViewer_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Me.CrystalReportViewer4.RefreshReport()
    End Sub

    Private Sub CrystalReportViewer4_Load(sender As Object, e As EventArgs) Handles CrystalReportViewer4.Load
