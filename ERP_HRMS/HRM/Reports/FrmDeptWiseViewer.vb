...
Public Class FrmDeptWiseViewer
    Friend Function ViewDeptReport(ByVal sReportName As String, Optional ByVal sSelectionFormula As String = "", Optional ByVal param As String = "") As Boolean
    ...
    End Function
    Private Sub FrmDeptWiseViewer_Load(sender As Object, e As EventArgs) Handles MyBase.Load
