...
Public Class frmCanteenAttendanceUploading
    ...
    Private Sub btnSave_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnSave.Click
        ...
        If DataGridView1.RowCount > 0 Then
            FilePath = "C:\Sports Excel Attendance Log Files\ Dated " & Now.Year & "-" & Now.Month & "-" & Now.Day & ".txt"
            ...
            If dgResult = 6 Then
                For i As Integer = 0 To Me.DataGridView1.RowCount - 1
                    If Me.View_Display_EmpInfoTableAdapter.FillBy(DSDisplayEI.View_Display_EmpInfo, Me.DataGridView1(0, i).Value) > 0 Then
                        ...
                        Try
                            Dim AttDate As Date = CDate(Me.DataGridView1(1, i).Value).ToShortDateString
            ...
            If GlobalPathStr <> "" Then
                ...
                If R = 1 Then
                    Try
                        ...
                        ExcelQurey = "SELECT CardNO ,AttDate from [Sheet1$]"
