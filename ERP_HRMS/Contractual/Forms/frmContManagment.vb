...
Public Class frmContManagment
    ...
    Private Sub emp_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        Me.Tbl_HRM_CardTableAdapter.FillBy2(Me.DSHRM.tbl_HRM_Card)
    ...
    Private Sub Button3_Click_1(sender As Object, e As EventArgs) Handles Button3.Click
        ...
        Year = Day / 365
        If Year <= 15 Then
            MessageBox.Show("Employee Age is Less Then 15 Years", "Employee Age ", MessageBoxButtons.OK, MessageBoxIcon.Error)
            Try
                Me.ValidateChildren()
    ...
    '            MessageBox.Show("Record Successfully Saved ", "Insertion Successfully", MessageBoxButtons.OK, MessageBoxIcon.Information)
    '            frmContManagment.Salaryflag = True
    ...
    '        Me.Tbl_HRM_Emp_InfoBindingSource.ResetBindings(True)
    '        Sectionflag = False
    '    ElseIf Designationflag = True
    '        Me.Tbl_HRM_DesignationTableAdapter.Fill(Me.DSHRM.tbl_HRM_Designation)
    '        Me.Tbl_HRM_Emp_InfoBindingSource.ResetBindings(True)
    '        Designationflag = False
    '    ElseIf catagoryflag = True
    '        Me.Tbl_HRM_EmpCatagoryTableAdapter.Fill(Me.DSHRM.tbl_HRM_EmpCatagory)
    '        Me.Tbl_HRM_Emp_InfoBindingSource.ResetBindings(True)
    '        catagoryflag = False
    '    ElseIf Employmentflag = True
    '        Me.Tbl_Hrm_EmploymentTableAdapter.Fill(Me.DSHRM.tbl_Hrm_Employment)
    '        Me.Tbl_HRM_Emp_InfoBindingSource.ResetBindings(True)
    '        Employmentflag = False
    '    ElseIf jobtypeflag = True
    '        Me.Tbl_HRM_JobTypeTableAdapter.Fill(Me.DSHRM.tbl_HRM_JobType)
    '        Me.Tbl_HRM_Emp_InfoBindingSource.ResetBindings(True)
    '        jobtypeflag = False
    '    ElseIf Shiftflag = True
    '        Me.Tbl_HRM_ShiftTableAdapter.Fill(Me.DSHRM.tbl_HRM_Shift)
    '        Me.Tbl_HRM_Emp_InfoBindingSource.ResetBindings(True)
    '        Shiftflag = False
    '    ElseIf Gradeflag = True
    '        Me.Tbl_HRM_GradeTableAdapter.Fill(Me.DSHRM.tbl_HRM_Grade)
    '        Me.Tbl_HRM_Emp_InfoBindingSource.ResetBindings(True)
    '        Gradeflag = False
    '    ElseIf Branchflag = True
    '        Me.Tbl_HRM_BranchTableAdapter.Fill(Me.DSHRM.tbl_HRM_Branch)

    '        Me.Tbl_HRM_Emp_InfoBindingSource.ResetBindings(True)
    '        Branchflag = False
    '    ElseIf Bankflag = True
    '        Me.Tbl_HRM_BankTableAdapter.Fill(Me.DSHRM.tbl_HRM_Bank)
    '        Me.Tbl_HRM_Emp_InfoBindingSource.ResetBindings(True)
    '        Bankflag = False
    '    ElseIf Notesflag = True
    '        Me.Tbl_Hrm_Emp_NoticesTableAdapter.Fill(Me.DSHRM.tbl_Hrm_Emp_Notices)
    '        Me.Tbl_HRM_Emp_InfoBindingSource.ResetBindings(True)
    '        Notesflag = False
    '    ElseIf Qualficationflag = True
    '        Me.Tbl_HRM_QualficationTableAdapter.Fill(Me.DSHRM.tbl_HRM_Qualfication)
    '        Me.Tbl_HRM_Emp_InfoBindingSource.ResetBindings(True)
    '        Qualficationflag = False
    '    ElseIf Cardflag = True
    '        Me.Tbl_HRM_CardTableAdapter.Fill(Me.DSHRM.tbl_HRM_Card)
    '        Me.Tbl_HRM_CardBindingSource.ResetBindings(True)
    '        Cardflag = False
    '    ElseIf Salaryflag = True
    '        Me.Tbl_Acc_Salary_NewTableAdapter.Fill(Me.DSHRM.tbl_Acc_Salary_New, Me.EmpIDLabel2.Text)
    ...
    Private Sub Save_Click(sender As Object, e As EventArgs) Handles Save.Click
        ...
        If MaskedTextBox2.Text = "  -  -" Then
            ...
            End If
        Else
            Dim dgResult As DialogResult = MessageBox.Show("Are you sure, you want To Terminate", "Terminate", MessageBoxButtons.YesNo)
            If dgResult = 6 Then
                Dim j As Int16 = Me.Tbl_HRM_Emp_InfoBindingSource.Position
                Try
                    Me.Tbl_HRM_Emp_InfoTableAdapter.ContStatusQuery(MaskedTextBox2.Text, EmpIDLabel2.Text)
                    'Tbl_HRM_CardTableAdapter.CardStatusOff(Me.CardNoLabel2.Text)
                    Me.Tbl_HRM_Emp_InfoTableAdapter.Fill(Me.DSHRM.tbl_HRM_Emp_Info, Me.CardNoLabel2.Text)
                    Me.Tbl_HRM_Emp_InfoBindingSource.Position = j
                    MessageBox.Show("Contractor Successfully Terminated ", "Termination Successfully", MessageBoxButtons.OK, MessageBoxIcon.Information)
                Catch ex As Exception
                    MsgBox(ex.Message)
                End Try
            End If
    ...
    Private Sub RadioButton3_CheckedChanged(sender As Object, e As EventArgs) Handles RadioButton3.CheckedChanged
        Me.Tbl_HRM_CardBindingSource.Filter = "CardStatus=false and CardNo>=50000"
        Me.Tbl_HRM_CardBindingSource.MoveFirst()
        Try
            Me.Tbl_HRM_Emp_InfoTableAdapter.Fill(Me.DSHRM.tbl_HRM_Emp_Info, Me.CardNoLabel2.Text)
        Catch ex As Exception
    ...
    Private Sub EndDateMaskedTextBox_GotFocus(sender As Object, e As EventArgs) Handles EndDateMaskedTextBox.GotFocus
        If EndDateMaskedTextBox.Text = "  -  -" Then
            EndDateMaskedTextBox.Text = DateAdd(DateInterval.Year, 1, CDate(Me.StartDateMaskedTextBox.Text))
        End If
    ...
    Private Sub AddCopyBtn_Click(sender As Object, e As EventArgs) Handles AddCopyBtn.Click
        ...
        If dgResult = 6 Then
            ...
            Try
                ...
                End If
                Me.EndDateMaskedTextBox.Text = DateAdd(DateInterval.Year, 1, CDate(Me.StartDateMaskedTextBox.Text))
    ...
    Private Sub DateTimePicker13_TextChanged(sender As Object, e As EventArgs) Handles DateTimePicker13.TextChanged
        MaskedTextBox2.Text = Me.DateTimePicker13.Text
    End Sub
    ...
    Private Sub DateTimePicker15_TextChanged(sender As Object, e As EventArgs) Handles DateTimePicker15.TextChanged
        MaskedTextBox3.Text = Me.DateTimePicker15.Text
    End Sub

    Private Sub Button7_Click(sender As Object, e As EventArgs) Handles Button7.Click
        Dim dgResult As DialogResult = MessageBox.Show("Are you sure, you want Activate ", "Activation", MessageBoxButtons.YesNo)
        If dgResult = 6 Then
            If Tbl_HRM_Emp_InfoTableAdapter.UpdateQuery(EmpIDLabel2.Text) > 0 Then
                MessageBox.Show("Contractor Has Been Successfully Activated ", "Successfully Activated", MessageBoxButtons.OK, MessageBoxIcon.Information)
                RefreshNow()
            End If
        End If
