Public Class frmPayrollManagment
    ...
    Private Sub loadReocrd()
        Try
            ...
            ElseIf TabControl1.SelectedTab.Text = "Leaves Management" Then
                If RadioButton2.Checked = True Then 'Filter By Date Range
                    FillByDateRange1()
                ElseIf RadioButton1.Checked = True Then 'Filter By Card Range
                    FillByCardRange1()
                ElseIf RadioButton3.Checked = True Then 'Filter By Card and Date Range
                    FillByCardAndDateRange1()
            ...
            ElseIf TabControl1.SelectedTab.Text = "Short Leaves" Then
                If RadioButton2.Checked = True Then 'Filter By Date Range
                    FillByDateRange2()
                ElseIf RadioButton1.Checked = True Then 'Filter By Card Range
                    FillByCardRange2()
                ElseIf RadioButton3.Checked = True Then 'Filter By Card and Date Range
                    FillByCardAndDateRange2()
                ElseIf RadioButton6.Checked = True Then 'Filter By Single Card, Single Date
                    FillByCardAndDate2()
                ElseIf RadioButton5.Checked = True Then 'Filter By Shift and  Date Range
                    FillByShiftDate2()
    ...
    Private Sub frmPayrollManagment_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        If (Me.Tbl_Comp_InfoTableAdapter.FillBy(Me.DSUser.tbl_Comp_Info)) > 0 Then
            Me.Tbl_Hrm_Emp_AttDataGridView1.Columns(7).Visible = False
            Me.Tbl_Hrm_Emp_AttDataGridView1.Columns(6).Visible = False
            Me.Tbl_Hrm_Emp_AttDataGridView1.Columns(8).Visible = False
            Me.Tbl_Hrm_Emp_AttDataGridView1.Columns(9).Visible = False
            Me.Tbl_PayRoll_LongLeavesDataGridView.Columns(9).Visible = False
            Me.Tbl_PayRoll_LongLeavesDataGridView.Columns(8).Visible = False
            CType(Me.Tbl_PayRoll_LongLeavesDataGridView.Columns(2), DataGridViewComboBoxColumn).Items.Add("Absent")
            CType(Me.Tbl_PayRoll_LongLeavesDataGridView.Columns(2), DataGridViewComboBoxColumn).Items.Add("Annual")
            CType(Me.Tbl_PayRoll_LongLeavesDataGridView.Columns(2), DataGridViewComboBoxColumn).Items.Add("Casual")
            CType(Me.Tbl_PayRoll_LongLeavesDataGridView.Columns(2), DataGridViewComboBoxColumn).Items.Add("Factory Duty")
            CType(Me.Tbl_PayRoll_LongLeavesDataGridView.Columns(2), DataGridViewComboBoxColumn).Items.Add("M1")
            CType(Me.Tbl_PayRoll_LongLeavesDataGridView.Columns(2), DataGridViewComboBoxColumn).Items.Add("M2")
            CType(Me.Tbl_PayRoll_LongLeavesDataGridView.Columns(2), DataGridViewComboBoxColumn).Items.Add("Sick")
            CType(Me.Tbl_PayRoll_LongLeavesDataGridView.Columns(2), DataGridViewComboBoxColumn).Items.Add("Suspended")
            CType(Me.Tbl_PayRoll_LongLeavesDataGridView.Columns(2), DataGridViewComboBoxColumn).Items.Add("Rest Day")
            CType(Me.Tbl_PayRoll_LongLeavesDataGridView.Columns(2), DataGridViewComboBoxColumn).Items.Add("Compensatory")
        Else
            Me.Tbl_Hrm_Emp_AttDataGridView1.Columns(7).Visible = True
            Me.Tbl_Hrm_Emp_AttDataGridView1.Columns(6).Visible = True
            Me.Tbl_Hrm_Emp_AttDataGridView1.Columns(8).Visible = True
            Me.Tbl_Hrm_Emp_AttDataGridView1.Columns(9).Visible = True
            Me.Tbl_PayRoll_LongLeavesDataGridView.Columns(9).Visible = True
            Me.Tbl_PayRoll_LongLeavesDataGridView.Columns(8).Visible = True
            CType(Me.Tbl_PayRoll_LongLeavesDataGridView.Columns(2), DataGridViewComboBoxColumn).Items.Add("Absent")
            CType(Me.Tbl_PayRoll_LongLeavesDataGridView.Columns(2), DataGridViewComboBoxColumn).Items.Add("Annual")
            CType(Me.Tbl_PayRoll_LongLeavesDataGridView.Columns(2), DataGridViewComboBoxColumn).Items.Add("Casual")
            CType(Me.Tbl_PayRoll_LongLeavesDataGridView.Columns(2), DataGridViewComboBoxColumn).Items.Add("Factory Duty")
            ...
            CType(Me.Tbl_PayRoll_LongLeavesDataGridView.Columns(2), DataGridViewComboBoxColumn).Items.Add("Suspended")
            CType(Me.Tbl_PayRoll_LongLeavesDataGridView.Columns(2), DataGridViewComboBoxColumn).Items.Add("Compensatory")
            CType(Me.Tbl_PayRoll_LongLeavesDataGridView.Columns(2), DataGridViewComboBoxColumn).Items.Add("OTAL")
            CType(Me.Tbl_PayRoll_LongLeavesDataGridView.Columns(2), DataGridViewComboBoxColumn).Items.Add("Special")
        End If
    ...
    Private Sub Tbl_Hrm_Emp_AttDataGridView_CellEndEdit(sender As Object, e As DataGridViewCellEventArgs) Handles Tbl_Hrm_Emp_AttDataGridView.CellEndEdit
        If e.ColumnIndex = 7 Then
            If Me.Tbl_Hrm_Emp_AttDataGridView(7, e.RowIndex).Value IsNot DBNull.Value Then
                Dim ShiftID As Integer = Me.Tbl_Hrm_Emp_AttDataGridView(7, e.RowIndex).Value
                If Me.Tbl_HRM_ShiftTableAdapter.FillBy(Me.DSPayRoll.tbl_HRM_Shift, ShiftID) = 1 Then
                    Dim selecteddate As Date = Me.Tbl_Hrm_Emp_AttDataGridView(3, e.RowIndex).Value
                    ...
                    Me.Tbl_Hrm_Emp_AttDataGridView(9, e.RowIndex).Value = Me.DSPayRoll.tbl_HRM_Shift(0).Item(2)
                    Me.Tbl_Hrm_Emp_AttDataGridView(10, e.RowIndex).Value = ShiftET
                    Me.Tbl_Hrm_Emp_AttDataGridView(11, e.RowIndex).Value = ShiftBST
                    Me.Tbl_Hrm_Emp_AttDataGridView(12, e.RowIndex).Value = ShiftBET
    ...
    Private Sub Tbl_Hrm_Emp_AttDataGridView_CellLeave(sender As Object, e As DataGridViewCellEventArgs) Handles Tbl_Hrm_Emp_AttDataGridView.CellLeave
        Dim Count As Integer
        Dim SUSCount As Integer
        ...
        If e.ColumnIndex = 3 Then
            If Me.Tbl_Hrm_Emp_AttDataGridView(1, e.RowIndex).Value IsNot DBNull.Value Then
                ...
                Try
                    ...
                    Count = Me.View_All_EmployeesTableAdapter.FillBy(Me.DSPayRoll.View_All_Employees, Val(Me.Tbl_Hrm_Emp_AttDataGridView(1, e.RowIndex).Value))
                Catch ex As Exception
                    Count = Me.View_All_EmployeesTableAdapter.FillBy(Me.DSPayRoll.View_All_Employees, Val(Me.Tbl_Hrm_Emp_AttDataGridView(1, e.RowIndex).Value))
                ...
                If Count = 1 Then
                    If Me.DSPayRoll.View_All_Employees.Rows(0).Item("SuspendStatus") = True Then
                        MsgBox("Employee is Ssuspended")
                        Me.Tbl_Hrm_Emp_AttBindingSource.RemoveCurrent()
                        ClearLabels()
                    Else
                        If Me.Tbl_Hrm_Emp_AttDataGridView(6, e.RowIndex).Value Is DBNull.Value And Me.Tbl_Hrm_Emp_AttDataGridView(7, e.RowIndex).Value Is DBNull.Value And Me.Tbl_Hrm_Emp_AttDataGridView(8, e.RowIndex).Value Is DBNull.Value And Me.Tbl_Hrm_Emp_AttDataGridView(9, e.RowIndex).Value Is DBNull.Value And Me.Tbl_Hrm_Emp_AttDataGridView(10, e.RowIndex).Value Is DBNull.Value And Me.Tbl_Hrm_Emp_AttDataGridView(11, e.RowIndex).Value Is DBNull.Value And Me.Tbl_Hrm_Emp_AttDataGridView(12, e.RowIndex).Value Is DBNull.Value Then

                            Me.Tbl_Hrm_Emp_AttDataGridView(6, e.RowIndex).Value = True
                            Me.Tbl_Hrm_Emp_AttDataGridView(2, e.RowIndex).Value = Me.DSPayRoll.View_All_Employees(0).Item("EmpID") 'EmpID
                            Me.Tbl_Hrm_Emp_AttDataGridView(7, e.RowIndex).Value = Me.DSPayRoll.View_All_Employees(0).Item("ShiftID") 'Shift ID
                            Dim ShiftID As Integer = Me.DSPayRoll.View_All_Employees(0).Item("ShiftID")
                            Dim SelectedDate As Date = Me.Tbl_Hrm_Emp_AttDataGridView(3, e.RowIndex).Value
                            ...
                            Dim ShiftBST As DateTime = Me.DSPayRoll.View_All_Employees(0).Item("BreakST")
                            Dim ShiftBET As DateTime = Me.DSPayRoll.View_All_Employees(0).Item("BreakET")
                            ...
                            If WeekdayName(Weekday(SelectedDate)) = "Friday" Then
                                ...
                                Else
                                    ...
                                    ShiftBST = Me.DSPayRoll.View_All_Employees(0).Item("BreakST")
                                    ShiftBET = Me.DSPayRoll.View_All_Employees(0).Item("BreakET")
                                End If
                            Else
                                ShiftST = Me.DSPayRoll.View_All_Employees(0).Item("ShiftST")
                                ShiftET = Me.DSPayRoll.View_All_Employees(0).Item("ShiftET")
                            ...
                            Me.Tbl_Hrm_Emp_AttDataGridView(9, e.RowIndex).Value = ShiftST
                            Me.Tbl_Hrm_Emp_AttDataGridView(10, e.RowIndex).Value = ShiftET
                            Me.Tbl_Hrm_Emp_AttDataGridView(11, e.RowIndex).Value = ShiftBST
                            Me.Tbl_Hrm_Emp_AttDataGridView(12, e.RowIndex).Value = ShiftBET
    ...
    Private Sub Tbl_Hrm_Emp_AttDataGridView_CellEnter(sender As Object, e As DataGridViewCellEventArgs) Handles Tbl_Hrm_Emp_AttDataGridView.CellEnter
        Dim dat As String = Nothing
        Dim tim As String = Nothing
        Dim Card As String = Nothing
        Dim Obj As UtilityClass = New UtilityClass
        If e.ColumnIndex > 3 Then
            If Me.Tbl_Hrm_Emp_AttDataGridView(13, e.RowIndex).Value Is DBNull.Value Then
                If Me.Tbl_Hrm_Emp_AttDataGridView(3, e.RowIndex).Value IsNot DBNull.Value Then
                    Dim FromDate As Date = Me.Tbl_Hrm_Emp_AttDataGridView(3, e.RowIndex).Value
                    Try
                        Me.Tbl_Hrm_Emp_AttDataGridView(13, e.RowIndex).Value = Obj.ReturnFP(FromDate.Month, FromDate.Year)
                    Catch ex As Exception
                        MsgBox(ex.Message)
                    End Try
                End If
            ...
            If e.ColumnIndex = 3 Then
                If Me.Tbl_Hrm_Emp_AttDataGridView(3, e.RowIndex).Value Is DBNull.Value Then
                    If e.RowIndex = 0 Then
                        dat = Now.Date.ToShortDateString()
                    ElseIf e.RowIndex > 0 Then
                        dat = Me.Tbl_Hrm_Emp_AttDataGridView(3, e.RowIndex - 1).Value
                    End If
                    Me.Tbl_Hrm_Emp_AttDataGridView(3, e.RowIndex).Value = dat
                End If
            ElseIf e.ColumnIndex = 4 Then
                If Me.Tbl_Hrm_Emp_AttDataGridView(4, e.RowIndex).Value Is DBNull.Value Then
                    If e.RowIndex = 0 Then
                        tim = Format(Now, "dd/MM/yyyy hh:mm tt")
                    ElseIf e.RowIndex > 0 Then
                        tim = Format(Me.Tbl_Hrm_Emp_AttDataGridView(4, e.RowIndex - 1).Value, "dd/MM/yyyy hh:mm tt")
                    End If
                    Me.Tbl_Hrm_Emp_AttDataGridView(4, e.RowIndex).Value = tim
                End If
        ...
        ElseIf RadioButton1.Checked = True Or RadioButton3.Checked = True Or RadioButton6.Checked = True Then
            If e.ColumnIndex = 1 Then
                If Me.Tbl_Hrm_Emp_AttDataGridView(1, e.RowIndex).Value Is DBNull.Value Then
                    If e.RowIndex = 0 Then
                        Card = CardNoComboBox.SelectedValue
                    ElseIf e.RowIndex > 0 Then
                        Card = Me.Tbl_Hrm_Emp_AttDataGridView(1, e.RowIndex - 1).Value
                    End If
                    Me.Tbl_Hrm_Emp_AttDataGridView(1, e.RowIndex).Value = Card
                End If
    ...
    Private Sub FillByDateRange()
        Dim Ret As Integer
        Ret = Me.Tbl_Hrm_Emp_AttTableAdapter.Fill(Me.DSPayRoll.tbl_Hrm_Emp_Att, Me.DateTimePicker1.Value.ToShortDateString(), Me.DateTimePicker2.Value.ToShortDateString())
        If Ret = 0 Then
            ClearLabels()
        End If
    End Sub
    Private Sub FillByCardAndDateRange()
        Dim Ret As Integer
        Ret = Me.Tbl_Hrm_Emp_AttTableAdapter.FillBy(Me.DSPayRoll.tbl_Hrm_Emp_Att, Me.DateTimePicker1.Value.ToShortDateString(), Me.DateTimePicker2.Value.ToShortDateString(), CardNoComboBox.SelectedValue, CardNoComboBox1.SelectedValue)
        If Ret = 0 Then
            ClearLabels()
        End If
    End Sub
    Private Sub FillByCardRange() 'Singel date
        Dim Ret As Integer
        Ret = Me.Tbl_Hrm_Emp_AttTableAdapter.FillBy1(Me.DSPayRoll.tbl_Hrm_Emp_Att, Me.DateTimePicker1.Value.ToShortDateString())
        If Ret = 0 Then
            ClearLabels()
        End If
    End Sub
    Private Sub FillByCardAndDate()
        Dim Ret As Integer
        Ret = Me.Tbl_Hrm_Emp_AttTableAdapter.FillBy2(Me.DSPayRoll.tbl_Hrm_Emp_Att, CardNoComboBox.SelectedValue, Me.DateTimePicker1.Value.ToShortDateString())
        If Ret = 0 Then
            ClearLabels()
        End If
    End Sub
    Private Sub FillByShiftDate()
        Dim Ret As Integer
        Ret = Me.Tbl_Hrm_Emp_AttTableAdapter.FillBy4(Me.DSPayRoll.tbl_Hrm_Emp_Att, Me.DateTimePicker1.Value.ToShortDateString(), Me.DateTimePicker2.Value.ToShortDateString(), ShiftNameComboBox.SelectedValue)
        If Ret = 0 Then
            ClearLabels()
        End If
    End Sub
    Private Sub FillByDateTime()
        Dim Ret As Integer
        Ret = Me.Tbl_Hrm_Emp_AttTableAdapter.FillBy5(Me.DSPayRoll.tbl_Hrm_Emp_Att, Me.DateTimePicker1.Value, Me.DateTimePicker2.Value)
        If Ret = 0 Then
            ClearLabels()
        End If
    End Sub

    Private Sub Tbl_Hrm_Emp_AttDataGridView_CellBeginEdit(sender As Object, e As DataGridViewCellCancelEventArgs) Handles Tbl_Hrm_Emp_AttDataGridView.CellBeginEdit
        If e.ColumnIndex = 4 Then
            If Me.Tbl_Hrm_Emp_AttDataGridView(4, e.RowIndex).Value IsNot DBNull.Value Then
                Me.Tbl_Hrm_Emp_AttDataGridView(6, e.RowIndex).Value = True
            End If
        End If
    End Sub
    ...
    Private Sub SaveNow()
        Me.Validate()
        Me.Tbl_Hrm_Emp_AttBindingSource.EndEdit()
        Me.Tbl_Hrm_Emp_AttTableAdapter.Update(DSPayRoll.tbl_Hrm_Emp_Att)
    End Sub
    ...
    Public Shared Function ChildWindowOpen(ByVal childWindow As String)
        For Each f As Form In frmPayrollManagment.MdiChildren
    ...
    Private Sub Tbl_PayRoll_LongLeavesDataGridView_CellEnter(sender As Object, e As DataGridViewCellEventArgs) Handles Tbl_PayRoll_LongLeavesDataGridView.CellEnter
        ...
        If e.ColumnIndex = 4 Then
            ...
            End Try
            If Me.DSPayRoll.View_All_Employees.Rows(0).Item("SuspendStatus") = True Then
                MsgBox("Employee is suspended Leave Can not be Entered")
                'Me.Tbl_PayRoll_LongLeavesBindingSource.ResetBindings(True)
                Me.Tbl_PayRoll_LongLeavesBindingSource.RemoveCurrent()
            ...
            Else
                If Count = 1 Then
                    ...
                    If Me.Tbl_PayRoll_LongLeavesDataGridView(4, e.RowIndex).Value Is DBNull.Value Then
                        ...
                        End If
                    End If
                    Dim FP As String = Me.Tbl_PayRoll_LongLeavesDataGridView(4, e.RowIndex).Value
                    Dim EMpID As Int16 = Tbl_PayRoll_LongLeavesDataGridView(1, e.RowIndex).Value
                    Me.Tbl_PayRoll_LongLeaves_CasualTableAdapter.Fill(Me.DSPayRoll.tbl_PayRoll_LongLeaves_Casual, EMpID, FP)
                Else
        ...
        If CheckBox2 = True Then
            If LeaveType = "Compensatory" Or LeaveType = "Casual" Or LeaveType = "M1" Or LeaveType = "Sick" Or LeaveType = "Special" Then
                ...
                If AgainstDate = Nothing Then
                    ...
                    Catch ex As Exception
                        Me.Tbl_PayRoll_LongLeavesTableAdapter.Insert(AutoCardNo, FP, LeaveType, AutoFromDate, Leave, 0, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing)
                    End Try


                Else
                    Me.Tbl_PayRoll_LongLeavesTableAdapter.Insert(AutoCardNo, FP, LeaveType, AutoFromDate, Leave, Leave_Status, Nothing, AgainstDate, Nothing, Nothing, Nothing, Nothing)
                ...
                If AutoCardNo <> Nothing Then
                    For i As Integer = 0 To DayNo
                        ...
                        If AutoFromDate.AddDays(i).ToString("dddd").Trim <> "Sunday".Trim Then
                            ...
                            Catch ex As Exception
                                Me.Tbl_PayRoll_LongLeavesTableAdapter.Insert(AutoCardNo, FP, LeaveType, AutoFromDate.AddDays(i), Leave, 0, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing)
                            End Try
    ...
    Private Sub AutoAttTextToDB()
        If ChildWindowOpen("frmAutoAttEmpEntry") = False Then
            Dim objPartialQty As New frmAutoAttEmpEntry
            frmAutoAttEmpEntry.Size = New System.Drawing.Size(800, 600)
            objPartialQty.Show()
    ...
    Private Sub Tbl_Hrm_Emp_AttDataGridView_EditingControlShowing(sender As Object, e As DataGridViewEditingControlShowingEventArgs) Handles Tbl_Hrm_Emp_AttDataGridView.EditingControlShowing
        If TypeOf e.Control Is DataGridViewComboBoxEditingControl Then
            CType(e.Control, ComboBox).DropDownStyle = ComboBoxStyle.DropDown
            CType(e.Control, ComboBox).AutoCompleteSource = AutoCompleteSource.ListItems
            CType(e.Control, ComboBox).AutoCompleteMode = System.Windows.Forms.AutoCompleteMode.SuggestAppend
    ...
    Private Sub Tbl_Hrm_Emp_AttDataGridView_DataError(sender As Object, e As DataGridViewDataErrorEventArgs) Handles Tbl_Hrm_Emp_AttDataGridView.DataError
    ...
    Private Sub Tbl_Hrm_Emp_AttBindingNavigatorSaveItem_Click_1(sender As Object, e As EventArgs) Handles Tbl_Hrm_Emp_AttBindingNavigatorSaveItem.Click
        ...
        Try
            Me.Validate()
            Me.Tbl_Hrm_Emp_AttBindingSource.EndEdit()
            Me.Tbl_Hrm_Emp_AttTableAdapter.Update(Me.DSPayRoll.tbl_Hrm_Emp_Att)
    ...
    Private Sub Tbl_Hrm_Emp_AttDataGridView_CellContentClick_1(sender As Object, e As DataGridViewCellEventArgs) Handles Tbl_Hrm_Emp_AttDataGridView.CellContentClick
        If RadioButton3.Checked = True Or RadioButton6.Checked = True Then
            If Me.Tbl_Hrm_Emp_AttDataGridView(1, e.RowIndex).Value Is DBNull.Value Then
                Me.Tbl_Hrm_Emp_AttDataGridView(1, e.RowIndex).Value = CardNoComboBox.Text
            End If
        End If
    End Sub
    ...
    Private Sub Tbl_Hrm_Emp_AttDataGridView_CellValueChanged(sender As Object, e As DataGridViewCellEventArgs) Handles Tbl_Hrm_Emp_AttDataGridView.CellValueChanged
        If Loadflag = True Then
            If e.ColumnIndex = 4 Then
                Try
                    If Tbl_Hrm_Emp_AttDataGridView(3, e.RowIndex).Value >= Me.View_All_EmployeesTableAdapter.DOJ(Me.Tbl_Hrm_Emp_AttDataGridView(2, e.RowIndex).Value) Then
                    Else
