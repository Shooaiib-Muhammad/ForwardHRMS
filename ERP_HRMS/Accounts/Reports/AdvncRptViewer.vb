...
Public Class AdvncRptViewer

    Friend Function ViewAdvanceReport(ByVal sReportName As String, Optional ByVal sSelectionFormula As String = "", Optional ByVal param As String = "") As Boolean
    ...
    Private Sub AdvncRptViewer_Load(sender As Object, e As EventArgs) Handles MyBase.Load
