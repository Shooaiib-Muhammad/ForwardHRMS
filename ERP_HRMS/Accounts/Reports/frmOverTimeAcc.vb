Public Class frmOverTimeAcc
    ...
    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        ...
        If Radio_OT.Checked = True Or RadioButton3.Checked = True Or RadioDTA.Checked = True Or RadioTravel.Checked = True Or Radio_Meal.Checked = True Or RadioButton5.Checked = True Or PndStatus.Checked = True Or NormalExtraSpecial.Checked = True Or PTPaymentDetails.Checked = True Or RadioButton8.Checked = True Then
        ...
        If Radio_OT.Checked = True Then ' OT Rpt
            If OT_Type.Text = "Normal" Then ' Normal
        ...
        If RadioButton3.Checked = True Then ' OT Slips
            Path = "" & frmLogin.ReportsPath & "\Accounts\rptAccOTPaymentSlip.rpt"
            Param = "FromDate=#" & Format(DateTimePicker1.Value, "dd/MM/yyyy") & "#&ToDate=#" & Format(DateTimePicker2.Value, "dd/MM/yyyy") & "#"

            If RadioByDate.Checked = True Then ' by Date
                Flag = False
                If RadioDeptAll.Checked = True Then ' By Emp
                    Filter = EmpStatus & " And   {tbl_Acc_ExtraOverTime_Transactions.Month} = " & Me.DateTimePicker1.Value.Month & " And {tbl_Acc_ExtraOverTime_Transactions.Year} = " & Me.DateTimePicker1.Value.Year & ""
                ElseIf MainDept.Checked = True Then ' main Dept
                    Filter = EmpStatus & " And {View_Rpt_Acc_PreSalary.DeptID} = " & DeptNameComboBox.SelectedValue & " And   {tbl_Acc_ExtraOverTime_Transactions.Month} = " & Me.DateTimePicker1.Value.Month & " And {tbl_Acc_ExtraOverTime_Transactions.Year} = " & Me.DateTimePicker1.Value.Year & ""
                ElseIf Section.Checked = True Then ' Section Wise
                    Filter = EmpStatus & " And {View_Rpt_Acc_PreSalary.DeptID} = " & DeptNameComboBox.SelectedValue & " And {View_Rpt_Acc_PreSalary.SubDept1ID} = " & NameComboBox.SelectedValue & " And   {tbl_Acc_ExtraOverTime_Transactions.Month} = " & Me.DateTimePicker1.Value.Month & " And {tbl_Acc_ExtraOverTime_Transactions.Year} = " & Me.DateTimePicker1.Value.Year & ""
                ElseIf DesigBTn.Checked = True Then ' Desig Wise
                    Filter = EmpStatus & " And {View_Rpt_Acc_PreSalary.DesigID} = " & DesigNameComboBox.SelectedValue & " And   {tbl_Acc_ExtraOverTime_Transactions.Month} = " & Me.DateTimePicker1.Value.Month & " And {tbl_Acc_ExtraOverTime_Transactions.Year} = " & Me.DateTimePicker1.Value.Year & ""
                End If
            ElseIf RadioDateCard.Checked = True Then ' by card
                If RadioDeptAll.Checked = True Then ' By Emp
                    ...
                    If tocard.Text = "" Then
                        ...
                        Filter = EmpStatus & " And {View_Rpt_Acc_PreSalary.CardNo} In " & Frmcard.Text & " To " & Frmcard.Text & " And   {tbl_Acc_ExtraOverTime_Transactions.Month} = " & Me.DateTimePicker1.Value.Month & " And {tbl_Acc_ExtraOverTime_Transactions.Year} = " & Me.DateTimePicker1.Value.Year & ""
                    Else

                        Filter = EmpStatus & " And {View_Rpt_Acc_PreSalary.CardNo} In " & Frmcard.Text & " To " & tocard.Text & " And   {tbl_Acc_ExtraOverTime_Transactions.Month} = " & Me.DateTimePicker1.Value.Month & " And {tbl_Acc_ExtraOverTime_Transactions.Year} = " & Me.DateTimePicker1.Value.Year & ""
                    End If
                ...
                ElseIf MainDept.Checked = True Then ' main Dept
                    ...
                    If tocard.Text = "" Then
                        ...
                        Filter = EmpStatus & " And {View_Rpt_Acc_PreSalary.DeptID} = " & DeptNameComboBox.SelectedValue & " And  {View_Rpt_Acc_PreSalary.CardNo} In " & Frmcard.Text & " To " & Frmcard.Text & " And   {tbl_Acc_ExtraOverTime_Transactions.Month} = " & Me.DateTimePicker1.Value.Month & " And {tbl_Acc_ExtraOverTime_Transactions.Year} = " & Me.DateTimePicker1.Value.Year & ""
                    Else

                        Filter = EmpStatus & " And {View_Rpt_Acc_PreSalary.DeptID} = " & DeptNameComboBox.SelectedValue & " And  {View_Rpt_Acc_PreSalary.CardNo} In " & Frmcard.Text & " To " & tocard.Text & " And   {tbl_Acc_ExtraOverTime_Transactions.Month} = " & Me.DateTimePicker1.Value.Month & " And {tbl_Acc_ExtraOverTime_Transactions.Year} = " & Me.DateTimePicker1.Value.Year & ""
                    End If
                ...
                ElseIf Section.Checked = True Then ' Section Wise
                    ...
                    If tocard.Text = "" Then
                        ...
                        Filter = EmpStatus & " And {View_Rpt_Acc_PreSalary.DeptID} = " & DeptNameComboBox.SelectedValue & " And {View_Rpt_Acc_PreSalary.SubDept1ID} = " & NameComboBox.SelectedValue & " And  {View_Rpt_Acc_PreSalary.CardNo} In " & Frmcard.Text & " To " & Frmcard.Text & " And   {tbl_Acc_ExtraOverTime_Transactions.Month} = " & Me.DateTimePicker1.Value.Month & " And {tbl_Acc_ExtraOverTime_Transactions.Year} = " & Me.DateTimePicker1.Value.Year & ""
                    Else

                        Filter = EmpStatus & " And {View_Rpt_Acc_PreSalary.DeptID} = " & DeptNameComboBox.SelectedValue & " And {View_Rpt_Acc_PreSalary.SubDept1ID} = " & NameComboBox.SelectedValue & " And  {View_Rpt_Acc_PreSalary.CardNo} In " & Frmcard.Text & " To " & tocard.Text & " And   {tbl_Acc_ExtraOverTime_Transactions.Month} = " & Me.DateTimePicker1.Value.Month & " And {tbl_Acc_ExtraOverTime_Transactions.Year} = " & Me.DateTimePicker1.Value.Year & ""
                    End If
                    'Filter = Empstatus & " And  {View_Rpt_Acc_PreSalary.DeptID} = " & DeptNameComboBox.SelectedValue & " And {View_Rpt_Acc_PreSalary.SubDept1ID} = '" & NameComboBox.Text & "' And {View_Att_DayGroup.AttDate}In #" & Format(Me.DateTimePicker1.Value, "MM/dd/yyyy") & "# To #" & Format(Me.DateTimePicker2.Value, "MM/dd/yyyy") & "#"
                ElseIf DesigBTn.Checked = True Then ' Desig Wise
                    If Frmcard.Text.Length = 0 Then
                        Flag = True
                    Else
                    ...
                    If tocard.Text = "" Then
                        ...
                        Filter = EmpStatus & " And {View_Rpt_Acc_PreSalary.DesigID} =" & DesigNameComboBox.SelectedValue & " And  {View_Rpt_Acc_PreSalary.CardNo} In " & Frmcard.Text & " To " & Frmcard.Text & " And   {tbl_Acc_ExtraOverTime_Transactions.Month} = " & Me.DateTimePicker1.Value.Month & " And {tbl_Acc_ExtraOverTime_Transactions.Year} = " & Me.DateTimePicker1.Value.Year & ""
                    Else

                        Filter = EmpStatus & " And {View_Rpt_Acc_PreSalary.DesigID} =" & DesigNameComboBox.SelectedValue & " And  {View_Rpt_Acc_PreSalary.CardNo} In " & Frmcard.Text & " To " & tocard.Text & " And   {tbl_Acc_ExtraOverTime_Transactions.Month} = " & Me.DateTimePicker1.Value.Month & " And {tbl_Acc_ExtraOverTime_Transactions.Year} = " & Me.DateTimePicker1.Value.Year & ""
                    End If
                End If
            ...
            ElseIf RadioSpecial.Checked = True Then ' By Speciall Filter
                ...
                For i As Integer = 0 To lstCards.Items.Count - 1
                    ...
                    End If
                Next
                Filter = EmpStatus & " And ({View_Rpt_Acc_PreSalary.CardNo}  in [" & Str & "]) And   {tbl_Acc_ExtraOverTime_Transactions.Month} = " & Me.DateTimePicker1.Value.Month & " And {tbl_Acc_ExtraOverTime_Transactions.Year} = " & Me.DateTimePicker1.Value.Year & ""
            ...
            ElseIf ByBranch.Checked = True Then ' By Branch
                Flag = False
                If RadioDeptAll.Checked = True Then ' By Emp
                    Filter = EmpStatus & " And {View_Rpt_Acc_PreSalary.BranchID}= " & BranchNameComboBox.SelectedValue & " And   {tbl_Acc_ExtraOverTime_Transactions.Month} = " & Me.DateTimePicker1.Value.Month & " And {tbl_Acc_ExtraOverTime_Transactions.Year} = " & Me.DateTimePicker1.Value.Year & ""
                ElseIf MainDept.Checked = True Then ' main Dept
                    Filter = EmpStatus & " And {View_Rpt_Acc_PreSalary.BranchID}= " & BranchNameComboBox.SelectedValue & " and {View_Rpt_Acc_PreSalary.DeptID} =" & DeptNameComboBox.SelectedValue & " And   {tbl_Acc_ExtraOverTime_Transactions.Month} = " & Me.DateTimePicker1.Value.Month & " And {tbl_Acc_ExtraOverTime_Transactions.Year} = " & Me.DateTimePicker1.Value.Year & ""
                ElseIf Section.Checked = True Then ' Section Wise
                    Filter = EmpStatus & " And {View_Rpt_Acc_PreSalary.BranchID}= " & BranchNameComboBox.SelectedValue & " and {View_Rpt_Acc_PreSalary.DeptID} = " & DeptNameComboBox.SelectedValue & " And {View_Rpt_Acc_PreSalary.SubDept1ID} = " & NameComboBox.SelectedValue & " And   {tbl_Acc_ExtraOverTime_Transactions.Month} = " & Me.DateTimePicker1.Value.Month & " And {tbl_Acc_ExtraOverTime_Transactions.Year} = " & Me.DateTimePicker1.Value.Year & ""
                ElseIf DesigBTn.Checked = True ' Desig Wise
                    Filter = EmpStatus & " And {View_Rpt_Acc_PreSalary.BranchID}= " & BranchNameComboBox.SelectedValue & " and  {View_Rpt_Acc_PreSalary.DesigID} = " & DesigNameComboBox.SelectedValue & " And   {tbl_Acc_ExtraOverTime_Transactions.Month} = " & Me.DateTimePicker1.Value.Month & " And {tbl_Acc_ExtraOverTime_Transactions.Year} = " & Me.DateTimePicker1.Value.Year & ""
                End If
            ElseIf ByShift.Checked = True Then ' By Shift
                Flag = False
                If RadioDeptAll.Checked = True Then ' By Emp
                    Filter = EmpStatus & " And {View_Rpt_Acc_PreSalary.shiftID}= " & ShiftNameComboBox.SelectedValue & " And   {tbl_Acc_ExtraOverTime_Transactions.Month} = " & Me.DateTimePicker1.Value.Month & " And {tbl_Acc_ExtraOverTime_Transactions.Year} = " & Me.DateTimePicker1.Value.Year & ""
                ElseIf MainDept.Checked = True Then ' main Dept
                    Filter = EmpStatus & " And {View_Rpt_Acc_PreSalary.shiftID}= " & ShiftNameComboBox.SelectedValue & " and {View_Rpt_Acc_PreSalary.DeptID} =" & DeptNameComboBox.SelectedValue & " And   {tbl_Acc_ExtraOverTime_Transactions.Month} = " & Me.DateTimePicker1.Value.Month & " And {tbl_Acc_ExtraOverTime_Transactions.Year} = " & Me.DateTimePicker1.Value.Year & ""
                ElseIf Section.Checked = True Then ' Section Wise
                ...
                ElseIf DesigBTn.Checked = True Then ' Desig Wise
                    Filter = EmpStatus & " And {View_Rpt_Acc_PreSalary.shiftID}= " & ShiftNameComboBox.SelectedValue & " and {View_Rpt_Acc_PreSalary.DesigID} = " & DesigNameComboBox.SelectedValue & " And   {tbl_Acc_ExtraOverTime_Transactions.Month} = " & Me.DateTimePicker1.Value.Month & " And {tbl_Acc_ExtraOverTime_Transactions.Year} = " & Me.DateTimePicker1.Value.Year & ""
                End If
            ElseIf RadioButton4.Checked = True Then ' By Category 
                Flag = False
                If RadioDeptAll.Checked = True Then ' By Emp
                    Filter = EmpStatus & " And {View_Rpt_Acc_PreSalary.EmpcatagoryID}  = " & CatagoryNameComboBox.SelectedValue & " And   {tbl_Acc_ExtraOverTime_Transactions.Month} = " & Me.DateTimePicker1.Value.Month & " And {tbl_Acc_ExtraOverTime_Transactions.Year} = " & Me.DateTimePicker1.Value.Year & ""
                ElseIf MainDept.Checked = True Then ' main Dept
                    Filter = EmpStatus & " And {View_Rpt_Acc_PreSalary.EmpcatagoryID}  = " & CatagoryNameComboBox.SelectedValue & " And {View_Rpt_Acc_PreSalary.DeptID} =" & DeptNameComboBox.SelectedValue & " And   {tbl_Acc_ExtraOverTime_Transactions.Month} = " & Me.DateTimePicker1.Value.Month & " And {tbl_Acc_ExtraOverTime_Transactions.Year} = " & Me.DateTimePicker1.Value.Year & ""
                ElseIf Section.Checked = True Then ' Section Wise
                    Filter = EmpStatus & " And {View_Rpt_Acc_PreSalary.EmpcatagoryID}  = " & CatagoryNameComboBox.SelectedValue & " And {View_Rpt_Acc_PreSalary.DeptID} = " & DeptNameComboBox.SelectedValue & " And {View_Rpt_Acc_PreSalary.SubDept1ID} = " & NameComboBox.SelectedValue & " And   {tbl_Acc_ExtraOverTime_Transactions.Month} = " & Me.DateTimePicker1.Value.Month & " And {tbl_Acc_ExtraOverTime_Transactions.Year} = " & Me.DateTimePicker1.Value.Year & ""
                ElseIf DesigBTn.Checked = True Then ' Desig Wise
                    Filter = EmpStatus & " And {View_Rpt_Acc_PreSalary.EmpcatagoryID}  = " & CatagoryNameComboBox.SelectedValue & " And {View_Rpt_Acc_PreSalary.DesigID} = " & DesigNameComboBox.SelectedValue & " And   {tbl_Acc_ExtraOverTime_Transactions.Month} = " & Me.DateTimePicker1.Value.Month & " And {tbl_Acc_ExtraOverTime_Transactions.Year} = " & Me.DateTimePicker1.Value.Year & ""
                End If
            End If

            '            {tbl_Acc_ExtraOverTime_Transactions.OTDate} >= {?FromDate} And
            '{tbl_Acc_ExtraOverTime_Transactions.OTDate} <= {?ToDate}
        End If
        ...
        If PndStatus.Checked = True Then
            ...
            If RadioByDate.Checked = True Then 'by Date
                Flag = False
                If RadioDeptAll.Checked = True Then ' By Emp
                    Filter = EmpStatus & " And  Not({View_Rpt_Acc_PreSalary.Grade} in ['E-1', 'E-2', 'E-3', 'M-1', 'M-2', 'M-3', 'M-4', 'M-5']) And {View_Att_DayGroup.AttDate}In #" & Format(Me.DateTimePicker1.Value, "MM/dd/yyyy") & "# To #" & Format(Me.DateTimePicker2.Value, "MM/dd/yyyy") & "#"
                ElseIf MainDept.Checked = True Then ' main Dept
                    Filter = EmpStatus & "And  Not({View_Rpt_Acc_PreSalary.Grade} in ['E-1', 'E-2', 'E-3', 'M-1', 'M-2', 'M-3', 'M-4', 'M-5']) And  {View_Rpt_Acc_PreSalary.DeptName} ='" & DeptNameComboBox.Text & "' And {View_Att_DayGroup.AttDate}In #" & Format(Me.DateTimePicker1.Value, "MM/dd/yyyy") & "# To #" & Format(Me.DateTimePicker2.Value, "MM/dd/yyyy") & "#"
                ElseIf Section.Checked = True Then ' Section Wise
                    Filter = EmpStatus & "And  Not({View_Rpt_Acc_PreSalary.Grade} in ['E-1', 'E-2', 'E-3', 'M-1', 'M-2', 'M-3', 'M-4', 'M-5']) And  {View_Rpt_Acc_PreSalary.DeptName} = '" & DeptNameComboBox.Text & "' And {View_Rpt_Acc_PreSalary.SectionName} = '" & NameComboBox.Text & "' And {View_Att_DayGroup.AttDate}In #" & Format(Me.DateTimePicker1.Value, "MM/dd/yyyy") & "# To #" & Format(Me.DateTimePicker2.Value, "MM/dd/yyyy") & "#"
                ElseIf DesigBTn.Checked = True Then ' Desig Wise
                    Filter = EmpStatus & " And  Not({View_Rpt_Acc_PreSalary.Grade} in ['E-1', 'E-2', 'E-3', 'M-1', 'M-2', 'M-3', 'M-4', 'M-5']) And {View_Rpt_Acc_PreSalary.desigName} = '" & DesigNameComboBox.Text & "' And {View_Att_DayGroup.AttDate}In #" & Format(Me.DateTimePicker1.Value, "MM/dd/yyyy") & "# To #" & Format(Me.DateTimePicker2.Value, "MM/dd/yyyy") & "#"
                End If
            ElseIf RadioDateCard.Checked = True ' By date and card No 
                If RadioDeptAll.Checked = True Then ' By Emp
                    If Frmcard.Text.Length = 0 Then
        ...
        If RadioButton5.Checked = True Then ' Overtime Payment Summary 
            ...
            If RadioByDate.Checked = True Then ' By date
                ...
                ElseIf Section.Checked = True Then ' Section Wise
                    Filter = EmpStatus & "And   {tbl_Acc_ExtraOverTime_Transactions.Month} = " & Me.DateTimePicker1.Value.Month & " And {tbl_Acc_ExtraOverTime_Transactions.Year} = " & Me.DateTimePicker1.Value.Year & " And {View_Rpt_Acc_PreSalary.DeptID} = " & DeptNameComboBox.SelectedValue & " And {View_Rpt_Acc_PreSalary.SubDept1ID} = " & NameComboBox.SelectedValue & ""

                ElseIf DesigBTn.Checked = True Then ' Desig Wise
                    Filter = EmpStatus & "And {View_Rpt_Acc_PreSalary.DesignationID} = " & DesigNameComboBox.SelectedValue & " And   {tbl_Acc_ExtraOverTime_Transactions.Month} = " & Me.DateTimePicker1.Value.Month & " And {tbl_Acc_ExtraOverTime_Transactions.Year} = " & Me.DateTimePicker1.Value.Year & ""
            ...
            ElseIf RadioDateCard.Checked = True ' By card
                ...
                ElseIf MainDept.Checked = True Then ' main Dept
                    ...
                    End If
                    If tocard.Text = "" Then
                        Filter = EmpStatus & " And  {View_Rpt_Acc_PreSalary.CardNo} In " & Frmcard.Text & " To " & Frmcard.Text & " And {View_Rpt_Acc_PreSalary.DeptID} = " & DeptNameComboBox.SelectedValue & " And   {tbl_Acc_ExtraOverTime_Transactions.Month} = " & Me.DateTimePicker1.Value.Month & " And {tbl_Acc_ExtraOverTime_Transactions.Year} = " & Me.DateTimePicker1.Value.Year & ""
                    Else

                        Filter = EmpStatus & " And {View_Rpt_Acc_PreSalary.CardNo} In " & Frmcard.Text & " To " & tocard.Text & " And {View_Rpt_Acc_PreSalary.DeptID} = " & DeptNameComboBox.SelectedValue & " And   {tbl_Acc_ExtraOverTime_Transactions.Month} = " & Me.DateTimePicker1.Value.Month & " And {tbl_Acc_ExtraOverTime_Transactions.Year} = " & Me.DateTimePicker1.Value.Year & ""
                    End If
                    'Filter = Empstatus & " And  {View_Rpt_Acc_AttListForOT.AttDate}In #" & Format(Me.DateTimePicker1.Value, "MM/dd/yyyy") & "# To #" & Format(Me.DateTimePicker2.Value, "MM/dd/yyyy") & "#"
                ElseIf Section.Checked = True Then ' Section Wise
                    If Frmcard.Text.Length = 0 Then
                ...
                ElseIf DesigBTn.Checked = True ' Desig Wise
                    ...
                    If tocard.Text = "" Then
                        ...
                        Filter = EmpStatus & " And  {View_Rpt_Acc_PreSalary.CardNo} In " & Frmcard.Text & " To " & Frmcard.Text & " And {View_Rpt_Acc_PreSalary.DesignationID} = " & DesigNameComboBox.SelectedValue & " And   {tbl_Acc_ExtraOverTime_Transactions.Month} = " & Me.DateTimePicker1.Value.Month & " And {tbl_Acc_ExtraOverTime_Transactions.Year} = " & Me.DateTimePicker1.Value.Year & ""
                    Else

                        Filter = EmpStatus & " And {View_Rpt_Acc_PreSalary.CardNo} In " & Frmcard.Text & " To " & tocard.Text & " And {View_Rpt_Acc_PreSalary.DesignationID} = " & DesigNameComboBox.SelectedValue & " And   {tbl_Acc_ExtraOverTime_Transactions.Month} = " & Me.DateTimePicker1.Value.Month & " And {tbl_Acc_ExtraOverTime_Transactions.Year} = " & Me.DateTimePicker1.Value.Year & ""
                    End If
                End If
            ...
            ElseIf ByShift.Checked = True Then ' By shiftss
                ...
                ElseIf Section.Checked = True Then ' Section Wise
                    Filter = EmpStatus & " And {View_Rpt_Acc_PreSalary.shiftID}= " & ShiftNameComboBox.SelectedValue & " and {View_Rpt_Acc_PreSalary.DeptID} = " & DeptNameComboBox.SelectedValue & " And {View_Rpt_Acc_PreSalary.SectionID} = " & NameComboBox.SelectedValue & "   And   {tbl_Acc_ExtraOverTime_Transactions.Month} = " & Me.DateTimePicker1.Value.Month & " And {tbl_Acc_ExtraOverTime_Transactions.Year} = " & Me.DateTimePicker1.Value.Year & ""
                ElseIf DesigBTn.Checked = True Then ' Desig Wise
                    Filter = EmpStatus & " And  {View_Rpt_Acc_PreSalary.shiftID}= " & ShiftNameComboBox.SelectedValue & " and {View_Rpt_Acc_PreSalary.DesignationID} = " & DesigNameComboBox.SelectedValue & " And   {tbl_Acc_ExtraOverTime_Transactions.Month} = " & Me.DateTimePicker1.Value.Month & " And {tbl_Acc_ExtraOverTime_Transactions.Year} = " & Me.DateTimePicker1.Value.Year & ""
        ...
        If RadioButton7.Checked = True Then
            If RadioByDate.Checked = True Then ' By Month
                Path = "" & frmLogin.ReportsPath & "\Accounts\RptOTDeptWiseSummary.rpt"
                Filter = " {View_Rpt_Dept_OT_Summary.Month}= " & DateTimePicker1.Value.Month & " And {View_Rpt_Dept_OT_Summary.Year}= " & DateTimePicker1.Value.Year & ""
            End If
        End If
        ...
        If RadioButton9.Checked = True Then
            ...
            If RadioByDate.Checked = True Then ' By date
                Flag = False
                If RadioDeptAll.Checked = True Then ' All EMp
                    Filter = EmpStatus & " And  {View_Union_OT_Calc.Year} = " & DateTimePicker1.Value.Year & " And {View_Union_OT_Calc.Month} = " & DateTimePicker1.Value.Month & ""

                ElseIf MainDept.Checked = True Then '  Main Dept
                    Filter = EmpStatus & "And {View_Union_OT_Calc.DeptID} = " & DeptNameComboBox.SelectedValue & " And {View_Union_OT_Calc.Month}= " & DateTimePicker1.Value.Month & " And {View_Union_OT_Calc.Year}= " & DateTimePicker1.Value.Year & " "

                ElseIf Section.Checked = True Then ' Section Wise
                    Filter = EmpStatus & "And {View_Union_OT_Calc.Month}= " & DateTimePicker1.Value.Month & " And {View_Union_OT_Calc.Year}= " & DateTimePicker1.Value.Year & "  And {View_Union_OT_Calc.DeptID} = " & DeptNameComboBox.SelectedValue & " And {View_Union_OT_Calc.SectionID} = " & NameComboBox.SelectedValue & ""

                ElseIf DesigBTn.Checked = True Then ' Desig Wise
                    Filter = EmpStatus & "And {View_Union_OT_Calc.DesignationID} = " & DesigNameComboBox.SelectedValue & " And {View_Union_OT_Calc.Month}= " & DateTimePicker1.Value.Month & " And {View_Union_OT_Calc.Year}= " & DateTimePicker1.Value.Year & " "
            ...
            ElseIf RadioDateCard.Checked = True ' By card
                If RadioDeptAll.Checked = True Then ' By Emp
                    ...
                    If tocard.Text = "" Then
                        ...
                        Filter = EmpStatus & " And  {View_Union_OT_Calc.CardNo} In " & Frmcard.Text & " To " & Frmcard.Text & " And  {View_Union_OT_Calc.Year} = " & DateTimePicker1.Value.Year & " And {View_Union_OT_Calc.Month} = " & DateTimePicker1.Value.Month & ""
                    Else
                        Filter = EmpStatus & " And  {View_Union_OT_Calc.CardNo} In " & Frmcard.Text & " To " & tocard.Text & " And  {View_Union_OT_Calc.Year} = " & DateTimePicker1.Value.Year & " And {View_Union_OT_Calc.Month} = " & DateTimePicker1.Value.Month & ""
                    End If
                ...
                ElseIf MainDept.Checked = True Then ' main Dept
                    ...
                    End If
                    If tocard.Text = "" Then
                        Filter = EmpStatus & " And  {View_Union_OT_Calc.CardNo} In " & Frmcard.Text & " To " & Frmcard.Text & " And {View_Union_OT_Calc.DeptID} = " & DeptNameComboBox.SelectedValue & " And  {View_Union_OT_Calc.Year} = " & DateTimePicker1.Value.Year & " And {View_Union_OT_Calc.Month} = " & DateTimePicker1.Value.Month & ""
                    Else

                        Filter = EmpStatus & " And {View_Union_OT_Calc.CardNo} In " & Frmcard.Text & " To " & tocard.Text & " And {View_Union_OT_Calc.DeptID} = " & DeptNameComboBox.SelectedValue & " And  {View_Union_OT_Calc.Year} = " & DateTimePicker1.Value.Year & " And {View_Union_OT_Calc.Month} = " & DateTimePicker1.Value.Month & ""
                    End If
                    'Filter = Empstatus & " And  {View_Rpt_Acc_AttListForOT.AttDate}In #" & Format(Me.DateTimePicker1.Value, "MM/dd/yyyy") & "# To #" & Format(Me.DateTimePicker2.Value, "MM/dd/yyyy") & "#"
                ElseIf Section.Checked = True Then ' Section Wise
                    If Frmcard.Text.Length = 0 Then
                    ...
                    If tocard.Text = "" Then
                        ...
                        Filter = EmpStatus & " And  {View_Union_OT_Calc.CardNo} In " & Frmcard.Text & " To " & Frmcard.Text & " And {View_Union_OT_Calc.DeptID} = " & DeptNameComboBox.SelectedValue & " And {View_Union_OT_Calc.SectionID} = " & NameComboBox.SelectedValue & "   And  {View_Union_OT_Calc.Year} = " & DateTimePicker1.Value.Year & " And {View_Union_OT_Calc.Month} = " & DateTimePicker1.Value.Month & ""

                    Else

                        Filter = EmpStatus & " And {View_Union_OT_Calc.CardNo} In " & Frmcard.Text & " To " & tocard.Text & " And {View_Union_OT_Calc.DeptID} = " & DeptNameComboBox.SelectedValue & " And {View_Union_OT_Calc.SectionID} = " & NameComboBox.SelectedValue & "  And  {View_Union_OT_Calc.Year} = " & DateTimePicker1.Value.Year & " And {View_Union_OT_Calc.Month} = " & DateTimePicker1.Value.Month & ""

                    End If
                    'Filter = Empstatus & " And  {View_Union_OT_Calc.DeptName} = '" & DeptNameComboBox.Text & "' And {View_Union_OT_Calc.SectionName} = '" & NameComboBox.Text & "' And {View_Union_OT_Calc.Month} In #" & Format(Me.DateTimePicker1.Value, "MM/dd/yyyy") & "# To #" & Format(Me.DateTimePicker2.Value, "MM/dd/yyyy") & "#"
                ElseIf DesigBTn.Checked = True ' Desig Wise
                    If Frmcard.Text.Length = 0 Then
                        Flag = True
                    Else
                    ...
                    If tocard.Text = "" Then
                        ...
                        Filter = EmpStatus & " And  {View_Union_OT_Calc.CardNo} In " & Frmcard.Text & " To " & Frmcard.Text & " And {View_Union_OT_Calc.DesignationID} = " & DesigNameComboBox.SelectedValue & " And  {View_Union_OT_Calc.Year} = " & DateTimePicker1.Value.Year & " And {View_Union_OT_Calc.Month} = " & DateTimePicker1.Value.Month & ""
                    Else

                        Filter = EmpStatus & " And {View_Union_OT_Calc.CardNo} In " & Frmcard.Text & " To " & tocard.Text & " And {View_Union_OT_Calc.DesignationID} = " & DesigNameComboBox.SelectedValue & " And  {View_Union_OT_Calc.Year} = " & DateTimePicker1.Value.Year & " And {View_Union_OT_Calc.Month} = " & DateTimePicker1.Value.Month & ""
                    End If
                End If
            ...
            ElseIf RadioSpecial.Checked = True Then ' Special Filter
                ...
                For i As Integer = 0 To lstCards.Items.Count - 1
                    ...
                    End If
                Next
                Filter = EmpStatus & " And  ({View_Union_OT_Calc.CardNo}  in [" & Str & "]) And  {View_Union_OT_Calc.Year} = " & DateTimePicker1.Value.Year & " And {View_Union_OT_Calc.Month} = " & DateTimePicker1.Value.Month & ""


            ElseIf ByBranch.Checked = True Then ' By Branch
                Flag = False
                If RadioDeptAll.Checked = True Then ' All EMp
                    Filter = EmpStatus & " And  {View_Union_OT_Calc.BranchID}= " & BranchNameComboBox.SelectedValue & " And  {View_Union_OT_Calc.Year} = " & DateTimePicker1.Value.Year & " And {View_Union_OT_Calc.Month} = " & DateTimePicker1.Value.Month & ""
                ElseIf MainDept.Checked = True Then '  Main Dept
                    Filter = EmpStatus & " And {View_Union_OT_Calc.BranchID}= " & BranchNameComboBox.SelectedValue & " and  {View_Union_OT_Calc.DeptID} = " & DeptNameComboBox.SelectedValue & " And  {View_Union_OT_Calc.Year} = " & DateTimePicker1.Value.Year & " And {View_Union_OT_Calc.Month} = " & DateTimePicker1.Value.Month & ""
                ...
                ElseIf DesigBTn.Checked = True Then ' Desig Wise
                    Filter = EmpStatus & " And {View_Union_OT_Calc.BranchID}= " & BranchNameComboBox.SelectedValue & " and  {View_Union_OT_Calc.DesignationID} = " & DesigNameComboBox.SelectedValue & " And  {View_Union_OT_Calc.Year} = " & DateTimePicker1.Value.Year & " And {View_Union_OT_Calc.Month} = " & DateTimePicker1.Value.Month & ""

                End If
            ElseIf ByShift.Checked = True Then ' By shiftss
                Flag = False
                If RadioDeptAll.Checked = True Then ' All EMp
                    Filter = EmpStatus & " And {View_Union_OT_Calc.shiftID}= " & ShiftNameComboBox.SelectedValue & " And  {View_Union_OT_Calc.Year} = " & DateTimePicker1.Value.Year & " And {View_Union_OT_Calc.Month} = " & DateTimePicker1.Value.Month & ""

                ElseIf MainDept.Checked = True Then '  Main Dept
                    Filter = EmpStatus & " And  {View_Union_OT_Calc.shiftID}= " & ShiftNameComboBox.SelectedValue & " and {View_Union_OT_Calc.DeptID} = " & DeptNameComboBox.SelectedValue & " And  {View_Union_OT_Calc.Year} = " & DateTimePicker1.Value.Year & " And {View_Union_OT_Calc.Month} = " & DateTimePicker1.Value.Month & ""
                ElseIf Section.Checked = True Then ' Section Wise
                    Filter = EmpStatus & " And {View_Union_OT_Calc.shiftID}= " & ShiftNameComboBox.SelectedValue & " and {View_Union_OT_Calc.DeptID} = " & DeptNameComboBox.SelectedValue & " And {View_Union_OT_Calc.SectionID} = " & NameComboBox.SelectedValue & "   And  {View_Union_OT_Calc.Year} = " & DateTimePicker1.Value.Year & " And {View_Union_OT_Calc.Month} = " & DateTimePicker1.Value.Month & ""
                ElseIf DesigBTn.Checked = True Then ' Desig Wise
                    Filter = EmpStatus & " And  {View_Union_OT_Calc.shiftID}= " & ShiftNameComboBox.SelectedValue & " and {View_Union_OT_Calc.DesignationID} = " & DesigNameComboBox.SelectedValue & " And  {View_Union_OT_Calc.Year} = " & DateTimePicker1.Value.Year & " And {View_Union_OT_Calc.Month} = " & DateTimePicker1.Value.Month & ""
        ...
        If RadioButton10.Checked = True Then
            ...
            Param = "FromDate=#" & Format(DateTimePicker1.Value, "dd/MM/yyyy") & "#&ToDate=#" & Format(DateTimePicker2.Value, "dd/MM/yyyy") & "#"
            If RadioByDate.Checked = True Then ' All 
                Flag = False
                If RadioDeptAll.Checked = True Then
                    Filter = "{View_OT_DateWise_DeptWise_AmtSum.AttDate}  In #" & Format(Me.DateTimePicker1.Value, "MM/dd/yyyy") & "# To #" & Format(Me.DateTimePicker2.Value, "MM/dd/yyyy") & "#"
                ElseIf MainDept.Checked = True Then
                    Filter = "{View_OT_DateWise_DeptWise_AmtSum.DeptID} = " & DeptNameComboBox.SelectedValue & " And {View_OT_DateWise_DeptWise_AmtSum.AttDate} In #" & Format(Me.DateTimePicker1.Value, "MM/dd/yyyy") & "# To #" & Format(Me.DateTimePicker2.Value, "MM/dd/yyyy") & "#"
                ElseIf Section.Checked = True Then
                    Filter = " {View_OT_DateWise_DeptWise_AmtSum.DeptID} = " & DeptNameComboBox.SelectedValue & " And {View_OT_DateWise_DeptWise_AmtSum.SectionID} = " & NameComboBox.SelectedValue & " And {View_OT_DateWise_DeptWise_AmtSum.AttDate} In #" & Format(Me.DateTimePicker1.Value, "MM/dd/yyyy") & "# To #" & Format(Me.DateTimePicker2.Value, "MM/dd/yyyy") & "#"

                End If
            ElseIf ByBranch.Checked = True
                Flag = False
                If RadioDeptAll.Checked = True Then ' All Dept

                    Filter = "{View_OT_DateWise_DeptWise_AmtSum.BranchID}= " & BranchNameComboBox.SelectedValue & " And {View_OT_DateWise_DeptWise_AmtSum.AttDate} In #" & Format(Me.DateTimePicker1.Value, "MM/dd/yyyy") & "# To #" & Format(Me.DateTimePicker2.Value, "MM/dd/yyyy") & "#"
                ElseIf MainDept.Checked = True Then ' Main Dept
                    Filter = "{View_OT_DateWise_DeptWise_AmtSum.BranchID}= " & BranchNameComboBox.SelectedValue & "    And {View_OT_DateWise_DeptWise_AmtSum.DeptID} = " & DeptNameComboBox.SelectedValue & " And {View_OT_DateWise_DeptWise_AmtSum.AttDate} In #" & Format(Me.DateTimePicker1.Value, "MM/dd/yyyy") & "# To #" & Format(Me.DateTimePicker2.Value, "MM/dd/yyyy") & "#"
                ElseIf Section.Checked = True Then ' MAni Secttion
                    Filter = " {View_OT_DateWise_DeptWise_AmtSum.BranchID}= " & BranchNameComboBox.SelectedValue & "  And  {View_OT_DateWise_DeptWise_AmtSum.DeptID} = " & DeptNameComboBox.SelectedValue & " And {View_OT_DateWise_DeptWise_AmtSum.SectionID} = " & NameComboBox.SelectedValue & " And {View_OT_DateWise_DeptWise_AmtSum.AttDate} In #" & Format(Me.DateTimePicker1.Value, "MM/dd/yyyy") & "# To #" & Format(Me.DateTimePicker2.Value, "MM/dd/yyyy") & "#"
