...
Public Class MISCRptViewer
    Friend Function ViewMISCReport(ByVal sReportName As String, Optional ByVal sSelectionFormula As String = "", Optional ByVal param As String = "") As Boolean
        ...
        Try
            ...
            End If
            CrystalReportViewer6.ReportSource = crReportDocument
            CrystalReportViewer6.Show()
            Return True
    ...
    Private Sub MISCRptViewer_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Me.CrystalReportViewer6.RefreshReport()
    End Sub

    Private Sub CrystalReportViewer6_Load(sender As Object, e As EventArgs) Handles CrystalReportViewer6.Load
